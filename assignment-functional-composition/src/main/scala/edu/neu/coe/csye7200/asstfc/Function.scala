...
import edu.neu.coe.csye7200.asstfc.Function.map2
...
object Function {
  ...
  //t1y flatMap (t1 => t2y flatMap (t2 => t3y flatMap (t3 => t4y flatMap (t4 => t5y flatMap (t5 => t6y flatMap(t6 => t7y map(t7 =>f(t1,t2,t3,t4,t5,t6,t7))))))))
  // TO BE IMPLEMENTED
